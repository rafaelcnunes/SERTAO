...
samples1 = loadMCSamples('chains/LCDM', settings={'ignore_rows':0.3})
...
g.triangle_plot([samples1], colors=['green'], legend_labels=['test'], legend_loc='upper right', filled=True)
